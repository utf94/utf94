...
- 🔭 Backend : CI, Django, Express, Loopback, Nestjs
- 🧩 Database : MySQL, PostgreSQL, MongoDB, Firestore, MariaDB, SQLite, SeaDB
- 💬 Language : Javascript, Typescript, Python, C++, Rust, WASM 
